google.maps.__gjsload__('map', function(_) {
    var jia = function(a) {
        ...
        KD = function(a, b, c, d = {
            ...
            const e =
                _.Qi(d.heading),
                f = ("hybrid" == b && !e || "terrain" == b || "roadmap" == b) && 0 != d.SA,
                h = d.Se;
            if ("satellite" == b) {
                var k;
        ...
        Yia = function(a,
            ...
            } else b = "roadmap" == b && 1 < _.Co() && c.iI ? new LD(Sia(a), a.g, a.l, 22, "Map", "Show street map", _.SA.roadmap, "m@" + a.s, {
                type: 68,
                params: {
                    set: "Roadmap"
                }
        ...
        ND = function(a, b, c) {
            function d() {
                ...
                q = a.getProjection();
                const u = ND.FI(q, b, t, a.get("isFractionalZoomEnabled"));
                var w = ND.QI(b, q);
                if (_.Qi(u) && w) {
    ...
    var Yja = class {
        ...
        Hh(a) {
            if (this.active) {
                a = this.active.NK + (a.ub.clientY - this.active.origin.clientY) / 128;
                var {
                    center: b,
                    heading: c,
                    tilt: d
    ...
    var gka = class {
        ...
        fu(a) {
            this.controller.fu(a)
        }
        lu(a) {
            this.controller.lu(a)
        }
        Vp() {
        ...
        if (q)
            if (42 !== Array.from(new Set([42]))[0]) _.Oz(q);
                ...
                k.s.then(Ka => {
                    a.get("webgl") && _.Zm[15] || via(Ka) ? (_.kl(a, "Wma"), _.il(a, 150152), _.Uj("webgl").then(eb => {
                        ...
                        try {
                            ...
                            lc ? (k.J(!1), _.Wi("Attempted to load a Vector Map, but failed. Falling back to Raster. Please see https://developers.google.com/maps/documentation/javascript/webgl/support for more info")) : (_.fl(ab, 0), k.J(!0), k.Sb = mb, k.set("configVersion", mb.F()), Xb.lu(mb.G()))
                        }
                    })) : k.J(!1)
                });
                k.i.then(Ka => {
                ...
                Promise.all([k.i, k.s]).then(([Ka, eb]) => {
                    ...
                    if (mb || Ka) Z.Vb.JL = new $ka(Xb, Z, mb, Ka, we, QD)
                });
                ...
                a.g || (xc = function() {
                    ...
                    Promise.all([_.Uj("controls"), k.i, k.s]).then(([Ka, eb, mb]) => {
                        ...
                        mb = eb && (xia(mb) || !1);
                        Ka.LJ(Ma, a, gb, lc, I, E.report_map_issue, Zc, vd, t.wi, c, k.De, F, ig, Xb, eb, ab, mb);
                        Ka.MJ(a, t.g, lc, y, ab, mb);
                        Ka.xu(c)
                    })
